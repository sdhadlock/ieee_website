  ...
  return (
    <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
      ...
      <section className="mb-14">
        <blockquote className="border-l-4 border-ieee-blue pl-6 py-2">
          <p className="text-xl text-gray-200 italic leading-relaxed">
            "Advancing technology for the benefit of humanity."
          </p>
          <footer className="text-ieee-blue text-sm mt-2 font-medium">— IEEE Mission</footer>
        </blockquote>
      </section>

      {/* What is IEEE */}
      <section className="mb-14">
        <h2 className="text-2xl font-semibold text-white mb-4 pl-4 border-l-4 border-ieee-blue">
          What is IEEE?
        </h2>
      ...
      <section>
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
          {[
            ...
            <div
              key={label}
              className="bg-ieee-dark-card border border-ieee-border rounded-xl p-6 text-center"
            >
              <p className="text-3xl font-bold text-ieee-blue">{stat}</p>
