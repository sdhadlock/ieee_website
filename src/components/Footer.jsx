...
export default function Footer() {
  return (
    <footer className="bg-ieee-navy border-t border-ieee-dark mt-20">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
        <div className="flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <div>
            <img
              ...
              className="h-10 mb-2"
            />
            <p className="text-ieee-pale/60 text-xs mt-1">
              Empowering engineers at Cornell University
            </p>
          </div>

          {/* Links */}
          <div className="flex items-center gap-6 text-sm text-ieee-pale/60">
        ...
        <div className="mt-8 pt-6 border-t border-ieee-dark text-center text-ieee-pale/40 text-xs">
